...
import static cn.people.weever.common.util.BitmapUtil.bmEnd;
import static cn.people.weever.common.util.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(WeeverApplication trackApp) {
...
//        String lastLocation = trackApp.trackConf.getString(SyncStateContract.Constants.LAST_LOCATION, null);
...
//        }
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > WeeverApplication.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > WeeverApplication.screenWidth - 200
                    || null == mapStatus) {
