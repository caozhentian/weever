...
public class RouteArrowView extends View {
    private Canvas myCanvas;
    private Paint myPaint=new Paint();

    public RouteArrowView(Context context) {
        super(context);
    }

    public RouteArrowView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

    }

    public RouteArrowView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
